...
void blur(int height, int width, RGBTRIPLE image[height][width])
{
    ...
    image[height - 1][width - 1].rgbtGreen = round((float)(image2[height - 1][width - 1].rgbtGreen + image2[height - 1][width - 2].rgbtGreen
                                             + image2[height - 2][width - 1].rgbtGreen + image2[height - 2][width - 2].rgbtGreen) / 4);
    image[height - 1][width - 1].rgbtBlue = round((float)(image2[height - 1][width - 1].rgbtBlue + image2[height - 1][width - 2].rgbtBlue
                                                + image2[height - 2][width - 1].rgbtBlue + image2[height - 2][width - 2].rgbtBlue) / 4);
